# README for the front end - project mockup and real implementation

### Find bellow a some snippets of the webapp and its mockup.
### You can also check out the html structure for yourself by:
+ Right-click on the file (or control-click on Mac).
+ Select Open With.
