...
// calorie filter does not work atm
...
//const calorieCheckBox = document.getElementById('calorie-check-box');
//
//// event listeners
//searchButton.addEventListener('click', getMealList);
//mealList.addEventListener('click', getMealRecipe);
...
//});
//
//// get meal list that matches input ingredients and calorie range
//function getMealList() {
//    let searchInputTxt = document.getElementById('search-input').value.trim();
//    let apiUrl = calorieCheckBox.checked ?
//        'https://api.spoonacular.com/recipes/findByNutrients' :
//        'https://api.spoonacular.com/recipes/complexSearch';
//
//    apiUrl += `?apiKey=${apiKey}&query=${searchInputTxt}`;
//
//    // Check if calorie filter is enabled
//    if (calorieCheckBox.checked) {
//        const minCalories = minCaloriesInput.value.trim();
//        const maxCalories = maxCaloriesInput.value.trim();
//
//        // Add calorie range to the API URL
//        apiUrl += `&minCalories=${minCalories}&maxCalories=${maxCalories}`;
//    }
//
//    // Fetch data from the API
//    fetch(apiUrl)
