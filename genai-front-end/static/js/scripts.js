...
document.addEventListener('DOMContentLoaded', () => {
      ...
      fetch(FAVORITES_BASE)
        ...
        .then(data => {
          ...
          if (Object.keys(data).length) {
            displayFavorites(Object.values(data));
    ...
    function displayFavorites(recipes) {
      ...
      recipes.forEach(r => {
        ...
        // image click
        const favImgEl = card.querySelector('.recipe-image img');
        favImgEl.style.cursor = 'pointer';
    ...
    /* display favorite created by user */
    ...
    /* CREATE recipe – payload now defaults empty string for image */
